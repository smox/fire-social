...
export const currentUser = {
    ...
    email: 'michael.brunner@sm0x.org',
    avatar: '/stockfotos_user/mb_profilfoto.webp',
}

export const AnnaSchmidt = {
    id: uuid(),
    name: 'Anna Schmidt',
